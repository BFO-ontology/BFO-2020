...
4. bfo-2020-relations-table.xlsx – table of all relations in BFO-2020-CL including all inverses and all binary variants used in BFO-2020-OWL
...
8. bfo-2020-without-some-all-times.owl – as for 5. but without the binaryized relations
The common-logic folder provides the complete set of modules in the CL formalization of BFO-2020 together with
9. temporalized-relations.cl, which contains CL definitions of the binary at-all-times/some-time relations used in bfo-2020-owl.
...
10. temporalized-relations.p9 – as for 9., but also in prover9 format.
