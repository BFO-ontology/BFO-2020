...
This work is licensed under a Creative Commons "Attribution 4.0 International" license: https://creativecommons.org/licenses/by/4.0/'
 ...
 (cl:ttl "https://basic-formal-ontology.org/2020/formulas/clif/spatial.cl" 
  ...
  (cl:comment 'occurs-in is dissective on first argument when it is an occurrent [jil-1]'
    (forall (p q r)
  ...
  (cl:comment 'located-in is dissective on first argument when it is a continuant [wty-1]'
    (forall (p q r s)
  ...
  (cl:comment 'occupies-spatial-region is functional on first argument [csx-1]'
    (forall (p q r s)
     (if
      (and (occupies-spatial-region p q r)
       (occupies-spatial-region s q r))
      (= p s))))
  ...
  (cl:comment 'Material entities occupy three dimensional spatial regions [hpz-1]'
    (forall (m t)
     (if (instance-of m material-entity t)
      (exists (t1 s)
       (and (temporal-part-of t1 t)
        (instance-of s three-dimensional-spatial-region t1)
        (occupies-spatial-region m s t1))))))
