...
This work is licensed under a Creative Commons "Attribution 4.0 International" license: https://creativecommons.org/licenses/by/4.0/'
 ...
 (cl:ttl "https://basic-formal-ontology.org/2020/formulas/clif/universal-declaration.cl" 
  ...
  (cl:comment 'disposition, role are mutually disjoint [bwk-2]'
    (not
     (exists (x t)
  ...
  (cl:comment 'continuant, occurrent are mutually disjoint [wrf-2]'
    (not
     (exists (x t)
  ...
  (cl:comment 'quality, realizable-entity are mutually disjoint [ksk-2]'
    (not
     (exists (x t)
  ...
  (cl:comment 'material-entity, immaterial-entity are mutually disjoint [sij-2]'
    (not
     (exists (x t)
  ...
  (cl:comment 'one-dimensional-temporal-region, zero-dimensional-temporal-region are mutually disjoint [zkj-2]'
    (not
     (exists (x t)
  ...
  (cl:comment 'No occurrent changes type during its existence [ayr-2]'
    (forall (o u t1 t2)
     (if (and (instance-of o occurrent t1) (instance-of o u t2))
      (and (instance-of o occurrent t2) (instance-of o u t1)))))
