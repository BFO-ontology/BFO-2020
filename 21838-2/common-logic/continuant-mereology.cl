...
This work is licensed under a Creative Commons "Attribution 4.0 International" license: https://creativecommons.org/licenses/by/4.0/'
 ...
 (cl:ttl "https://basic-formal-ontology.org/2020/formulas/clif/continuant-mereology.cl" 
  ...
  (cl:comment 'If a continuant-part-of b then if a is an instance of spatial-region then b is an instance of spatial-region, and vice-versa [kbr-2]'
    (forall (p q t)
  ...
  (cl:comment 'If a continuant-part-of b then if a is an instance of independent-continuant then b is an instance of independent-continuant, and vice-versa [cez-2]'
    (forall (p q t)
     (if (continuant-part-of p q t)
      (iff (instance-of p independent-continuant t)
       (instance-of q independent-continuant t)))))
  ...
  (cl:comment 'A fiat line occupies a one-dimensional spatial region [kcq-2]'
    (forall (x t)
  ...
  (cl:comment 'A fiat point occupies a zero-dimensional spatial region [alm-2]'
    (forall (x t)
  ...
  (cl:comment 'A fiat surface occupies a two-dimensional spatial region [fpl-2]'
    (forall (x t)
  ...
  (cl:comment 'If at any time that two non-object aggregates exist each is part of the other, then they are identical [tab-1]'
    (forall (a b)
     (if
      (exists (t)
