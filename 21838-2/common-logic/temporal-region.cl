...
This work is licensed under a Creative Commons "Attribution 4.0 International" license: https://creativecommons.org/licenses/by/4.0/'
 ...
 (cl:ttl "https://basic-formal-ontology.org/2020/formulas/clif/temporal-region.cl" 
  ...
  (cl:comment 'A one-dimensional temporal region has at least one interval as part [jhe-2]'
    (forall (t)
     (if (instance-of t one-dimensional-temporal-region t)
      (exists (p)
  ...
  (cl:comment 'temporal regions are instances at themselves [tvx-3]'
    (forall (a b)
     (and
      (forall (c)
       (if (and (instance-of a b c) (instance-of a temporal-region c))
        (instance-of a b a)))
      (if (instance-of a b a) (instance-of a temporal-region a)))))
