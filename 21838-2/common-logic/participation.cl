...
This work is licensed under a Creative Commons "Attribution 4.0 International" license: https://creativecommons.org/licenses/by/4.0/'
 ...
 (cl:ttl "https://basic-formal-ontology.org/2020/formulas/clif/participation.cl" 
  ...
  (cl:comment 'participates-in is time indexed and has domain: independent-continuant or specifically-dependent-continuant or generically-dependent-continuant  but not spatial-region and range: process [ild-2]'
    (forall (a b t)
     (if (participates-in a b t)
      (and
       (and
        (or (instance-of a independent-continuant t)
  ...
  (cl:comment 'If a generically dependent continuant participates in a process p then, if it is concretized as a process, that process is part of p, and if concretized as an sdc then the bearer of that sdc participates in the process [fmm-1]'
    (forall (gdc p t)
     (if
